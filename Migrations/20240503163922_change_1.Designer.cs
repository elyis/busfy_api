...
namespace busfy_api.Migrations
{
    ...
    [Migration("20240503163922_change_1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("busfy_api.src.Domain.Models.Post", b =>
                {
                    ...
                    b.HasKey("CreatorId", "CategoryName");
            ...
            modelBuilder.Entity("busfy_api.src.Domain.Models.PostComment", b =>
                {
                    ...
                    b.HasIndex("PostCreatorId", "PostCategoryName");
            ...
            modelBuilder.Entity("busfy_api.src.Domain.Models.SubscriptionToAdditionalContent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SubscriptionsToAdditionalContent");
                });
            ...
            modelBuilder.Entity("busfy_api.src.Domain.Models.UserCreation", b =>
                {
                    ...
                    b.HasIndex("ContentCategoryName");
            ...
            modelBuilder.Entity("busfy_api.src.Domain.Models.PostComment", b =>
                {
                    ...
                    b.HasOne("busfy_api.src.Domain.Models.Post", "Post")
                        .WithMany("Comments")
                        .HasForeignKey("PostCreatorId", "PostCategoryName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("busfy_api.src.Domain.Models.UserCreation", b =>
                {
                    b.HasOne("busfy_api.src.Domain.Models.ContentCategory", "ContentCategory")
                        .WithMany("UserCreations")
                        .HasForeignKey("ContentCategoryName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("busfy_api.src.Domain.Models.UserSubscription", b =>
                {
                    b.HasOne("busfy_api.src.Domain.Models.SubscriptionToAdditionalContent", "Subscription")
                        .WithMany("Subscriptions")
